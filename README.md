...
1. 运行 100 题 paired 实验（fixed + rp4 + rp8 三臂，512 窗口，含复跑判定，约 6–7 小时），报告 bootstrap 置信区间 / McNemar 检验，画出"省算力 vs 抓救回"权衡曲线。
2. 视 100 题结果决定是否补 `alpha`（2 vs 4）与 `gain_threshold` 对照。
